...
const CreateCourse = () => {
  ...
  return (
    <div className="bg-cover bg-center min-h-screen" style={{ backgroundImage: `url('https://t4.ftcdn.net/jpg/07/21/42/77/360_F_721427746_lUH6mQG2AvlLkdKlNhHq2gZfQmrRLpqp.jpg')` }}>
      ...
      <div className="container mx-auto p-6 bg-white bg-opacity-90 rounded-lg shadow-lg mt-8 max-w-md">
        <h2 className="text-white text-2xl mb-6">Create a New Course</h2>
